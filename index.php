...
<section class="banner-sec home-banner" style="background-image:url(asset/img/Image-JPG.png);">
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
...
<main class="main-bx">
			...
			<div class="row align-items-center work-bg-curve">
				<div class="col-lg-3 col-sm-6 mt-4">
					<div class="work-bx d-flex flex-column justify-content-center">
						<div class="icon-dv">
							<span class="icon">
								<img class="white-icon" src="asset/img/icon-1.png" alt="Icon">
								<img class="blue-icon" src="asset/img/Blue-icon-1.png" alt="Icon">
							</span>
						</div>
				...
				<div class="col-lg-3 col-sm-6 mt-4">
					<div class="work-bx d-flex flex-column justify-content-center">
						<div class="icon-dv">
							<span class="icon">
								<img class="white-icon" src="asset/img/icon-2.png" alt="Icon">
								<img class="blue-icon" src="asset/img/Blue-icon-2.png" alt="Icon">
							</span>
						</div>
						<div class="heading-dv">
				...
				<div class="col-lg-3 col-sm-6 mt-4">
					<div class="work-bx d-flex flex-column justify-content-center">
						<div class="icon-dv">
							<span class="icon">
								<img class="white-icon" src="asset/img/icon-3.png" alt="Icon">
								<img class="blue-icon" src="asset/img/Blue-icon-3.png" alt="Icon">
							</span>
						</div>
						<div class="heading-dv">
				...
				<div class="col-lg-3 col-sm-6 mt-4">
					<div class="work-bx d-flex flex-column justify-content-center">
						<div class="icon-dv">
							<span class="icon">
								<img class="white-icon" src="asset/img/icon-4.png" alt="Icon">
								<img class="blue-icon" src="asset/img/Blue-icon-4.png" alt="Icon">
							</span>
						</div>
						<div class="heading-dv">
	...
	<section class="meet-you-sec pb-5">
		<div class="container-fluid">
			<div class="row">
					...
					<div class="img h-100">
						<div class="row h-100">
							...
							<div class="col-md-6 pl-0">
								<div class="img-3"><img src="asset/img/image-3.png" alt="Image"></div>
							</div>
				...
				<div class="col-lg-6">
					<div class="entry-txt">
						<h2 class="entry-title text-black">We'd Love  to Meet You</h2>
						<div class="txt">
	...
	<section class="call-us-sec">
		<section class="common-sec bg-img-sec text-white link-sec text-center" style="background-image:url(asset/img/CTA.png);">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 mt-4">
					<div class="blog-dv">
						<div class="img">
							<a class="h-100" href="javascript:void(0);"><img src="asset/img/blog-1.png" alt="Image"></a>
							<div class="date">
						...
						<div class="entry-txt">
							<h4 class="text-black">Buyer Story: Edward - First Time Buyer</h4>
							<p class="m-0">Which First Mortgage branch did you use?Edward: Edinburgh Walker StreetWhat made... <a href="javascript:void(0);">Read</a></p>
						</div><!-- entry-txt -->
					</div>
				</div><!-- col -->
				...
				<div class="col-lg-4 mt-4">
					<div class="blog-dv">
						<div class="img">
							<a class="h-100" href="javascript:void(0);"><img src="asset/img/Blog-2.png" alt="Image"></a>
							<div class="date">
				...
				<div class="col-lg-4 mt-4">
					<div class="blog-dv">
						<div class="img">
							<a class="h-100" href="javascript:void(0);"><img src="asset/img/Blog-3.png" alt="Image"></a>
							<div class="date">
